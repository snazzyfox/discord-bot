...
async def get_secret_config(key: str) -> dict[int, SecretStr]:
...
async def get_config(guild: hikari.Guild | int | None, key: str) -> str | list[str]:
...
async def _get_config(guild_id: int, key: str) -> str | None:
    ...
    return value.config_value if value else None
