...
@plugin.command
@lightbulb.command("profile_admin", description="Manage profile cards", guilds=(351122293105229835,))
@lightbulb.implements(lightbulb.SlashCommandGroup)
async def profile_admin_group(ctx: lightbulb.SlashContext) -> None:
    pass
